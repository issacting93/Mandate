...
| **ASSET** | 1x1 | Orange | A Community Asset discovered via Listening (e.g., local generator). Placed to act as a free bridge/synergy link without requiring FUNDING. |
